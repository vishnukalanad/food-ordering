...
export default function Cart() {
    ...
    return <Modal className={""} open={userCtx.progress === 'cart'} onClose={userCtx.progress === 'cart' ? handleCartClose : null}>
        <div className="flex flex-col justify-between h-full">
            ...
            <div className="mt-4 flex gap-4 justify-end">
                ...
                {
                    items.length > 0 && <button className="bg-blue-200 px-2 py-2 rounded-lg font-medium text-sm text-blue-900 cursor-pointer" onClick={handleCheckout}>Checkout</button>
                }
            </div>
        </div>
    </Modal>
